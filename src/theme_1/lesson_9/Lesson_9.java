...
//   Чтение из файла
        InputStream stream = new FileInputStream("./src/theme_1.txt/lesson_9/file.txt");
...
//   Чтение из файла с подсчетом
        InputStream stream2 = new FileInputStream("./src/theme_1.txt/lesson_9/qwerty.txt");
...
//  Запись в файл
        PrintWriter writer = new PrintWriter("./src/theme_1.txt/lesson_9/out.txt");
        if (op == '*') {
